                    ...
                    for ($i = count($dataWeather) - 1; $i >= 0; $i--) {
                        for ($j = count($dataWeather) - 1; $j >= 0; $j--) {
                            if ($dateStart == date("d - m - Y", ($dataWeather[$j]["dt"]))) {
                                $tempMin = min($dataWeather[$i]["main"]["temp_min"], $dataWeather[$j]["main"]["temp_min"]);
                                $tempMax = max($dataWeather[$i]["main"]["temp_max"], $tempMax);
