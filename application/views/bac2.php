        ...
        <div class="row">
            ...
            ?>
                ...
                <div class="avg-section col-12">
                    <h2>Current Weather: <?= floor($dataWeather[0]["main"]["temp"]); ?> C</h2>
                ...
                <div class="card-deck col-lg-12">
                    ...
                    for ($i = count($dataWeather) - 1; $i >= 0; $i--) {
                        ...
                        for ($j = count($dataWeather) - 1; $j >= 0; $j--) {
                            ...
                            if ($dateStart == date("d - m - Y", ($dataWeather[$j]["dt"])) && $flag) {
                        ...
                        if ($date == date("d - m - Y", ($dataWeather[$i]["dt"]))) {
                            ...
                            //     diff.innerHTML =" . round($tempDiff / 5) . ";
                            // </script>";
                            // echo $tempMax . " " . $tempMin . " $tempDiff <br> ";
